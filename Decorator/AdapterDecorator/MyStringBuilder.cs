...
namespace Decorator.AdapterDecorator
{
    public class MyStringBuilder
    {
        ...
        //public MyStringBuilder Append(char* value, int valueCount)
        //{
        ...
        public MyStringBuilder Append(MyStringBuilder value, int startIndex, int count)
        {
            _builder.Append(value.ToString(), startIndex, count);
            return this;
        }
